  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className="absolute right-1 sm:right-5 bottom-0 sm:bottom-3 pr-1 pl-4 py-1 bg-white/80 rounded-full flex gap-3 justify-between items-center hover:bg-white transition-all duration-300 w-fit"
        >
          {t("start")}
