  ...
  return (
    <div className="relative flex items-center md:justify-start w-full h-[800px] xxl:h-[1000px]">
      <div className="flex flex-col justify-center md:px-12 lg:px-28 pt-10 md:pt-[70px] ml-1 xs:ml-5 md:ml-0 pr-[20%] xs:pr-[30%] sm:pr-0 text-[#001a70] z-10">
        <h1 className="hidden sm:block text-7xl xxl:text-8xl font-[latoblack] mb-2 text-nowrap">
          {t("h1a")} <br /> {t("h1b")} <br /> {t("h1c")}
        </h1>

        <div className=" mb-4">
          <h2 className="text-3xl xxl:text-5xl ">{t("h2")}</h2>
        </div>
      </div>
      <div className="absolute top-0 right-0 w-[900px] xxl:w-[1200px] h-full">
        <div className="relative w-full h-full ">
          ...
          />
          <div className="absolute top-[385px] xxl:top-[480px] left-[215px] xxl:left-[288px] cursor-pointer group">
            <div className="relative w-9 xxl:w-12 aspect-square bg-[url(/img/kissimmeemapa.png)] group-hover:bg-[url(/img/kissimmeemapahover.png)] bg-contain bg-no-repeat bg-center transition-all duration-300 hover:scale-105 xxl:group-hover:scale-110 ">
              <div className="relative w-[50px] xxl:w-[70px] aspect-square -top-11 xxl:-top-14 group-hover:scale-105 xxl:group-hover:scale-110 transition-all duration-300">
                <Image
          ...
          <div className="absolute top-[444px] xxl:top-[558px] left-[260px] xxl:left-[348px] group">
            <div
          ...
          <div className="relative w-[70px] xxl:w-[90px] aspect-square top-[270px] xxl:top-[350px] left-[380px] xxl:left-[480px] group hover:scale-105 xxl:group-hover:scale-110 transition-all duration-300 cursor-pointer">
            <Image
              src="/img/fyrloisicon.png"
              layout="fill"
              objectFit="contain"
