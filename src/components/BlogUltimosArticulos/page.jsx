          ...
          return (
            ...
            >
              <div className="relative w-full min-h-[300px]">
                ...
                />
                <div className="absolute right-0 py-2 px-3 mt-2 mr-2  bg-[#001A70] rounded-full flex justify-center items-center text-white">
                  <p>{item?.tarjeta?.categoria}</p>
                </div>
              </div>
              <div className="mx-5 py-3 ">
                <h3 className="text-xl font-bold text-[#001A70] py-2">
                  {item?.tarjeta?.titulo}
                </h3>
              ...
              <div className="mx-4 py-5 text-xl text-[#001A70] font-bold border-t-[1px] border-gray-500">
